...
void Window::onPaint() {
  ...
  //  //Renderize a segunda instância do modelo
  // abcg::glUniformMatrix4fv(modelMatrixLoc, 1, GL_FALSE, &m_modelMatrix[0][0]);
  // m_model.render(m_trianglesToDraw);
  // m_modelMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(-1.0f, 0.0f, 0.0f)) *
...
void Window::onUpdate() {
  ...
  // Modifique a posição da segunda instância
