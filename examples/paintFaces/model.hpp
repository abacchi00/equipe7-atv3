...
public:
  ...
  void loadFaceTexture(int faceIndex, std::string_view path);
  ...
  GLuint m_faceTextures[6]{}; // Armazena as texturas de cada face

  std::vector<Vertex> m_vertices;
  std::vector<GLuint> m_indices;
  std::vector<std::pair<int, int>> getFaceTrianglePairs() const;
